...
After trying this in my selenium test, it worked perfectly ([My simplistic solution can be found here](https://gist.github.com/vivrichards600/8a42aed3ca7ab7c4f2219952de067f3e)). Of coursethere is lots of refactoring that could and should be done, but as this was just to a bit of fun, I'm not too concerned.
